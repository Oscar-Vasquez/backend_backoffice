...
var CustomerController = function () {
    ...
    var CustomerController = _classThis = /** @class */ (function () {
        ...
        CustomerController_1.prototype.create = function (createCustomerDto) {
            console.log('🎯 POST /api/customers');
            console.log('📦 Datos recibidos:', JSON.stringify(createCustomerDto, null, 2));
            return this.customerService.create(createCustomerDto);
        };
        CustomerController_1.prototype.findAll = function () {
            console.log('🎯 GET /api/customers');
            return this.customerService.findAll();
        };
        CustomerController_1.prototype.findOne = function (id) {
            console.log("\uD83C\uDFAF GET /api/customers/".concat(id));
            return this.customerService.findOne(id);
        };
        CustomerController_1.prototype.update = function (id, updateCustomerDto) {
            console.log("\uD83C\uDFAF PUT /api/customers/".concat(id));
            console.log('📦 Datos actualizados:', JSON.stringify(updateCustomerDto, null, 2));
            return this.customerService.update(id, updateCustomerDto);
        };
        CustomerController_1.prototype.remove = function (id) {
            console.log("\uD83C\uDFAF DELETE /api/customers/".concat(id));
